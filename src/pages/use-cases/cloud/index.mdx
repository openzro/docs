...
Deploy openZro across cloud environments to securely connect workloads, enable hybrid cloud connectivity, and simplify multi-cloud networking.
...
- **Serverless**: Run openZro on FaaS platforms for ephemeral, secure connectivity
- **Container Orchestration**: Deploy openZro as a daemon set on ECS, EKS, or other container platforms
    ...
    items={[
        {
            ...
            name: 'openZro on AWS ECS',
            description: 'Deploy openZro as an ECS daemon set using Terraform',
        },
        {
            href: '/use-cases/cloud/openzro-on-faas',
            name: 'openZro on Serverless (FaaS)',
            description: 'Run openZro on serverless platforms for ephemeral connectivity',
        },
        {
...
- Security groups must allow traffic from openZro routing peers
