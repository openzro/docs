...
```shell
/container envs
add key=NB_SETUP_KEY name=openzro value=YOUR_OPENZRO_SETUP_KEY
...
```shell
add key=NB_MANAGEMENT_URL name=openzro value=YOUR_OPENZRO_MANAGEMENT_URL
add key=NB_ADMIN_URL name=openzro value=YOUR_OPENZRO_ADMIN_URL
```
