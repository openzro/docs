...
<Note>
- For the openZro client-side outbound port reference, see the [FAQ: What firewall ports should I open to use openZro?](/about-openzro/faq#what-firewall-ports-should-i-open-to-use-openzro-network-firewalls)
- For the server-side port matrix of a self-hosted deployment, see the [self-hosted guide](/selfhosted/selfhosted-guide#port-requirements)
</Note>
---
