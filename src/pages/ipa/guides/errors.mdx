...
Here is a list of the different categories of status codes returned by the openZro API. Use these to understand if a request was successful.
...
<Properties>
  ...
  <Property name="5xx">
    A 5xx status code indicates a server error - in this case please reach out to us via [Slack](/slack-url) or [GitHub](https://github.com/openzro/openzro/issues).
  </Property>
</Properties>
