export const description =
  'This guide will get you all set up and ready to use the openZro API. We’ll cover how to get started and how to make your first API request.'
...
Before making your first API request, you need to create an access token to authenticate requests to the API. You can create an access token in the [openZro dashboard](https://app.openzro.io) under [Users &raquo; Me](https://app.openzro.io/users).
