...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/accounts \
...
url = "https://api.openzro.io/api/accounts"
...
url = URI("https://api.openzro.io/api/accounts")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/accounts',
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/accounts/{accountId} \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/accounts/{accountId}"
...
url = URI("https://api.openzro.io/api/accounts/{accountId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/accounts/{accountId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/accounts/{accountId} \
-H 'Accept: application/json' \
