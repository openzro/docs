...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/peers \
...
url = "https://api.openzro.io/api/peers"
...
url = URI("https://api.openzro.io/api/peers")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/peers',
...
[
  {
    ...
    "ui_version": "0.14.0",
    "dns_label": "stage-host-1.openzro.cloud",
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/peers/{peerId} \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/peers/{peerId}"
...
url = URI("https://api.openzro.io/api/peers/{peerId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/peers/{peerId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/peers/{peerId} \
-H 'Accept: application/json' \
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/peers/{peerId} \
-H 'Authorization: Token <TOKEN>' 
```
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/peers/{peerId}/accessible-peers \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/peers/{peerId}/accessible-peers"
...
url = URI("https://api.openzro.io/api/peers/{peerId}/accessible-peers")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/peers/{peerId}/accessible-peers',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/peers/{peerId}/temporary-access \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
url = "https://api.openzro.io/api/peers/{peerId}/temporary-access"
payload = json.dumps({
  "name": "temp-host-1",
  "wg_pub_key": "n0r3pL4c3h0ld3rK3y==",
  "rules": [
...
url = URI("https://api.openzro.io/api/peers/{peerId}/temporary-access")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/peers/{peerId}/temporary-access',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
