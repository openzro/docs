...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/routes \
...
url = "https://api.openzro.io/api/routes"
...
url = URI("https://api.openzro.io/api/routes")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/routes',
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/routes \
-H 'Accept: application/json' \
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/routes/{routeId} \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/routes/{routeId}"
...
url = URI("https://api.openzro.io/api/routes/{routeId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/routes/{routeId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/routes/{routeId} \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/routes/{routeId} \
-H 'Authorization: Token <TOKEN>' 
```
