...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/dns/nameservers \
...
url = "https://api.openzro.io/api/dns/nameservers"
...
url = URI("https://api.openzro.io/api/dns/nameservers")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/dns/nameservers',
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/dns/nameservers \
-H 'Accept: application/json' \
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/dns/nameservers/{nsgroupId} \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/dns/nameservers/{nsgroupId}"
...
url = URI("https://api.openzro.io/api/dns/nameservers/{nsgroupId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/dns/nameservers/{nsgroupId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/dns/nameservers/{nsgroupId} \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/dns/nameservers/{nsgroupId} \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/dns/settings"
...
url = URI("https://api.openzro.io/api/dns/settings")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/dns/settings',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
