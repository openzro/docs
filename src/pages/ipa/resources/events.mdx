...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/events/audit \
...
url = "https://api.openzro.io/api/events/audit"
...
url = URI("https://api.openzro.io/api/events/audit")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/events/audit',
...
[
  {
    ...
    "initiator_email": "demo@openzro.io",
...
## List all Traffic Events  <Badge status="cloud-only" text="cloud-only" hoverText="This feature is only available in the cloud version of openZro." />  <Badge status="experimental" text="experimental" hoverText="This feature is experimental. The endpoint will likely change and we do not guarantee backwards compatibility." />  {{ tag: 'GET' , label: '/api/events/network-traffic' }}
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/events/network-traffic \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/events/network-traffic"
...
url = URI("https://api.openzro.io/api/events/network-traffic")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/events/network-traffic',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/events/proxy \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/events/proxy"
...
url = URI("https://api.openzro.io/api/events/proxy")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/events/proxy',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
