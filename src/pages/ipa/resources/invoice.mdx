...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/integrations/billing/invoices \
...
url = "https://api.openzro.io/api/integrations/billing/invoices"
...
url = URI("https://api.openzro.io/api/integrations/billing/invoices")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/integrations/billing/invoices',
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/integrations/billing/invoices/{id}/pdf \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/integrations/billing/invoices/{id}/pdf"
...
url = URI("https://api.openzro.io/api/integrations/billing/invoices/{id}/pdf")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/integrations/billing/invoices/{id}/pdf',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/integrations/billing/invoices/{id}/csv \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/integrations/billing/invoices/{id}/csv"
...
url = URI("https://api.openzro.io/api/integrations/billing/invoices/{id}/csv")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/integrations/billing/invoices/{id}/csv',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
