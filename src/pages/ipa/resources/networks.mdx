...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/networks \
...
url = "https://api.openzro.io/api/networks"
...
url = URI("https://api.openzro.io/api/networks")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/networks',
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/networks \
-H 'Accept: application/json' \
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/networks/{networkId} \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/networks/{networkId}"
...
url = URI("https://api.openzro.io/api/networks/{networkId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/networks/{networkId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/networks/{networkId} \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/networks/{networkId} \
-H 'Authorization: Token <TOKEN>' 
```
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/networks/{networkId}/resources \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/networks/{networkId}/resources"
...
url = URI("https://api.openzro.io/api/networks/{networkId}/resources")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/networks/{networkId}/resources',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/networks/{networkId}/resources \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/networks/{networkId}/resources/{resourceId} \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/networks/{networkId}/resources/{resourceId}"
...
url = URI("https://api.openzro.io/api/networks/{networkId}/resources/{resourceId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/networks/{networkId}/resources/{resourceId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/networks/{networkId}/resources/{resourceId} \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/networks/{networkId}/resources/{resourceId} \
-H 'Authorization: Token <TOKEN>' 
```
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/networks/{networkId}/routers \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/networks/{networkId}/routers"
...
url = URI("https://api.openzro.io/api/networks/{networkId}/routers")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/networks/{networkId}/routers',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/networks/{networkId}/routers \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/networks/{networkId}/routers/{routerId} \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/networks/{networkId}/routers/{routerId}"
...
url = URI("https://api.openzro.io/api/networks/{networkId}/routers/{routerId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/networks/{networkId}/routers/{routerId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/networks/{networkId}/routers/{routerId} \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/networks/{networkId}/routers/{routerId} \
-H 'Authorization: Token <TOKEN>' 
```
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/networks/routers \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/networks/routers"
...
url = URI("https://api.openzro.io/api/networks/routers")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/networks/routers',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
