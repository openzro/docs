...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/setup-keys \
...
url = "https://api.openzro.io/api/setup-keys"
...
url = URI("https://api.openzro.io/api/setup-keys")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/setup-keys',
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/setup-keys \
-H 'Accept: application/json' \
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/setup-keys/{keyId} \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/setup-keys/{keyId}"
...
url = URI("https://api.openzro.io/api/setup-keys/{keyId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/setup-keys/{keyId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/setup-keys/{keyId} \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/setup-keys/{keyId} \
-H 'Authorization: Token <TOKEN>' 
```
