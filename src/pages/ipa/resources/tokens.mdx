...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/users/{userId}/tokens \
...
url = "https://api.openzro.io/api/users/{userId}/tokens"
...
url = URI("https://api.openzro.io/api/users/{userId}/tokens")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/users/{userId}/tokens',
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/users/{userId}/tokens \
-H 'Accept: application/json' \
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/users/{userId}/tokens/{tokenId} \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/users/{userId}/tokens/{tokenId}"
...
url = URI("https://api.openzro.io/api/users/{userId}/tokens/{tokenId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/users/{userId}/tokens/{tokenId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/users/{userId}/tokens/{tokenId} \
-H 'Authorization: Token <TOKEN>' 
```
