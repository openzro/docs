...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/locations/countries \
...
url = "https://api.openzro.io/api/locations/countries"
...
url = URI("https://api.openzro.io/api/locations/countries")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/locations/countries',
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/locations/countries/{country}/cities \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/locations/countries/{country}/cities"
...
url = URI("https://api.openzro.io/api/locations/countries/{country}/cities")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/locations/countries/{country}/cities',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
