...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/instance \
...
url = "https://api.openzro.io/api/instance"
...
url = URI("https://api.openzro.io/api/instance")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/instance',
...
<Row>
  <Col>
    Returns version information for openZro components including the current management server version and latest available versions from GitHub.
              </Col>

  <Col sticky>
    <CodeGroup title="Request" tag="GET" label="/api/instance/version">
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/instance/version \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/instance/version"
...
url = URI("https://api.openzro.io/api/instance/version")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/instance/version',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/setup \
-H 'Accept: application/json' \
...
url = "https://api.openzro.io/api/setup"
payload = json.dumps({
  "email": "admin@example.com",
  "password": "securepassword123",
  "name": "Admin User"
...
url = URI("https://api.openzro.io/api/setup")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/setup',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
