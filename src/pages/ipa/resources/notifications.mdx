...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/integrations/notifications/types \
...
url = "https://api.openzro.io/api/integrations/notifications/types"
...
url = URI("https://api.openzro.io/api/integrations/notifications/types")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/integrations/notifications/types',
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/integrations/notifications/channels \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/integrations/notifications/channels"
...
url = URI("https://api.openzro.io/api/integrations/notifications/channels")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/integrations/notifications/channels',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
[
  {
    ...
    "target": {
      ...
      "oneOf": [
        ...
        {
          "url": "https://hooks.example.com/openzro",
          "headers": {
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/integrations/notifications/channels \
-H 'Accept: application/json' \
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/integrations/notifications/channels/{channelId} \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/integrations/notifications/channels/{channelId}"
...
url = URI("https://api.openzro.io/api/integrations/notifications/channels/{channelId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/integrations/notifications/channels/{channelId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/integrations/notifications/channels/{channelId} \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/integrations/notifications/channels/{channelId} \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
