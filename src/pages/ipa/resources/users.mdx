...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/users \
...
url = "https://api.openzro.io/api/users"
...
url = URI("https://api.openzro.io/api/users")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/users',
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/users \
-H 'Accept: application/json' \
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/users/{userId} \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
url = "https://api.openzro.io/api/users/{userId}"
payload = json.dumps({
  "role": "admin",
  "auto_groups": [
    "ch8i4ug6lnn4g9hqv7m0"
...
url = URI("https://api.openzro.io/api/users/{userId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/users/{userId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/users/{userId} \
-H 'Authorization: Token <TOKEN>' 
```
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/users/{userId}/invite \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/users/{userId}/invite"
...
url = URI("https://api.openzro.io/api/users/{userId}/invite")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/users/{userId}/invite',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/users/{userId}/approve \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/users/{userId}/approve"
...
url = URI("https://api.openzro.io/api/users/{userId}/approve")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/users/{userId}/approve',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/users/{userId}/reject \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/users/{userId}/reject"
...
url = URI("https://api.openzro.io/api/users/{userId}/reject")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/users/{userId}/reject',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/users/{userId}/password \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
url = "https://api.openzro.io/api/users/{userId}/password"
payload = json.dumps({
  "old_password": "currentPassword123",
  "new_password": "newSecurePassword456"
})
...
url = URI("https://api.openzro.io/api/users/{userId}/password")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/users/{userId}/password',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/users/current \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/users/current"
...
url = URI("https://api.openzro.io/api/users/current")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/users/current',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/users/invites \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/users/invites"
...
url = URI("https://api.openzro.io/api/users/invites")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/users/invites',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/users/invites \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/users/invites/{inviteId} \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/users/invites/{inviteId}"
...
url = URI("https://api.openzro.io/api/users/invites/{inviteId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/users/invites/{inviteId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/users/invites/{inviteId}/regenerate \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
url = "https://api.openzro.io/api/users/invites/{inviteId}/regenerate"
payload = json.dumps({
  "expires_in": 259200
})
headers = {   
...
url = URI("https://api.openzro.io/api/users/invites/{inviteId}/regenerate")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/users/invites/{inviteId}/regenerate',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/users/invites/{token} \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/users/invites/{token}"
...
url = URI("https://api.openzro.io/api/users/invites/{token}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/users/invites/{token}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/users/invites/{token}/accept \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
url = "https://api.openzro.io/api/users/invites/{token}/accept"
payload = json.dumps({
  "password": "SecurePass123!"
})
headers = {   
...
url = URI("https://api.openzro.io/api/users/invites/{token}/accept")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/users/invites/{token}/accept',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
