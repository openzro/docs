...
url = "https://api.openzro.io/api/peers/{peer-id}/edr/bypass"
...
url = URI("https://api.openzro.io/api/peers/{peer-id}/edr/bypass")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/peers/{peer-id}/edr/bypass',
...
url = "https://api.openzro.io/api/peers/edr/bypassed"
...
url = URI("https://api.openzro.io/api/peers/edr/bypassed")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/peers/edr/bypassed',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
