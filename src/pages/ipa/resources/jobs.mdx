...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/peers/{peerId}/jobs \
...
url = "https://api.openzro.io/api/peers/{peerId}/jobs"
...
url = URI("https://api.openzro.io/api/peers/{peerId}/jobs")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/peers/{peerId}/jobs',
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/peers/{peerId}/jobs/{jobId} \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/peers/{peerId}/jobs/{jobId}"
...
url = URI("https://api.openzro.io/api/peers/{peerId}/jobs/{jobId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/peers/{peerId}/jobs/{jobId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
