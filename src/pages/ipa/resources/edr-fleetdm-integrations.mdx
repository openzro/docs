...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/integrations/edr/fleetdm \
...
url = "https://api.openzro.io/api/integrations/edr/fleetdm"
payload = json.dumps({
  "api_url": {
    "type": "string",
    "description": "FleetDM server URL"
...
url = URI("https://api.openzro.io/api/integrations/edr/fleetdm")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/integrations/edr/fleetdm',
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/integrations/edr/fleetdm \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/integrations/edr/fleetdm \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/integrations/edr/fleetdm \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
