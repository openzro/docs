...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/integrations/edr/intune \
...
url = "https://api.openzro.io/api/integrations/edr/intune"
payload = json.dumps({
  "client_id": {
    "type": "string",
    "description": "The Azure application client id"
...
url = URI("https://api.openzro.io/api/integrations/edr/intune")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/integrations/edr/intune',
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/integrations/edr/intune \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/integrations/edr/intune \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/integrations/edr/intune \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
