...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/posture-checks \
...
url = "https://api.openzro.io/api/posture-checks"
...
url = URI("https://api.openzro.io/api/posture-checks")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/posture-checks',
...
[
  {
    ...
    "name": "Default",
    "description": "This checks if the peer is running required openZro's version",
    "checks": {
      "nb_version_check": {
        "min_version": "14.3"
      },
        ...
        "processes": [
          {
            ...
            "windows_path": "C: rogramDataetBird\openzro.exe"
          }
        ]
      }
    }
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/posture-checks \
-H 'Accept: application/json' \
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/posture-checks/{postureCheckId} \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/posture-checks/{postureCheckId}"
...
url = URI("https://api.openzro.io/api/posture-checks/{postureCheckId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/posture-checks/{postureCheckId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/posture-checks/{postureCheckId} \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/posture-checks/{postureCheckId} \
-H 'Authorization: Token <TOKEN>' 
```
