...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/groups \
...
url = "https://api.openzro.io/api/groups"
...
url = URI("https://api.openzro.io/api/groups")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/groups',
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/groups \
-H 'Accept: application/json' \
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/groups/{groupId} \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/groups/{groupId}"
...
url = URI("https://api.openzro.io/api/groups/{groupId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/groups/{groupId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/groups/{groupId} \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/groups/{groupId} \
-H 'Authorization: Token <TOKEN>' 
```
