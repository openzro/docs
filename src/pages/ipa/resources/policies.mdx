...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/policies \
...
url = "https://api.openzro.io/api/policies"
...
url = URI("https://api.openzro.io/api/policies")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/policies',
...
<Row>
  <Col>
    ...
    <Property name="protocol" type="string" required={true} enumList={["all","tcp","udp","icmp","openzro-ssh"]}>
...
```bash {{ title: 'cURL' }}
curl -X POST https://api.openzro.io/api/policies \
-H 'Accept: application/json' \
...
```bash {{ title: 'cURL' }}
curl -X GET https://api.openzro.io/api/policies/{policyId} \
-H 'Accept: application/json' \
-H 'Authorization: Token <TOKEN>' 
```
...
url = "https://api.openzro.io/api/policies/{policyId}"
...
url = URI("https://api.openzro.io/api/policies/{policyId}")
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://api.openzro.io/api/policies/{policyId}',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
```bash {{ title: 'cURL' }}
curl -X PUT https://api.openzro.io/api/policies/{policyId} \
-H 'Accept: application/json' \
-H 'Content-Type: application/json' \
-H 'Authorization: Token <TOKEN>' \
--data-raw '{
...
```bash {{ title: 'cURL' }}
curl -X DELETE https://api.openzro.io/api/policies/{policyId} \
-H 'Authorization: Token <TOKEN>' 
```
