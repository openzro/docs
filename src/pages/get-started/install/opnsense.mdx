...
<Note>
    The openZro package is officially included starting from OPNsense `25.7.3`.
</Note>
...
<Note>
    OPNsense includes native WireGuard support, however do not configure or manage the openZro interface (wt0) via the OPNsense WireGuard UI.
