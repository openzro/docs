...
<Button href="https://your-management.example.com/" arrow="right" children="Download openZro" />
...
{/* TrueNAS hidden from the hub — page is paused pending a decision on
    whether to submit `openzro-client` to the TrueNAS Apps catalog. */}
