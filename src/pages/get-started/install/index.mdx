...
If you're a new user you should visit the [Quickstart Guide](https://docs.openzro.io/get-started). This will help you setup your management dashboard and connect your first client. For quick install instructions, including desktop applications, visit the [install prompt](https://app.openzro.io/install) through the management dashboard. To view all the client installation methods we've set up a variety of platform specific pages.

<Button href="https://app.openzro.io/install" arrow="right" children="Download openZro" />
