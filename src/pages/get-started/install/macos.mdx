...
1. Download the latest MacOS release installer for your [processor](https://support.apple.com/en-us/HT211814 ):
    - Intel: <Button href="https://pkgs.openzro.io/macos/amd64" variant="text" arrow="right">Download openZro for Intel</Button>
    - M1 & M2: <Button href="https://pkgs.openzro.io/macos/arm64" variant="text" arrow="right">Download openZro for Apple Silicon</Button><br />
