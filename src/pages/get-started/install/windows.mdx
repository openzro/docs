...
1. Download the latest Windows release:
    - <Button href="https://github.com/openzro/openzro/releases/latest" variant="text">EXE Installer</Button><br />
    - <Button href="https://github.com/openzro/openzro/releases/latest" variant="text">MSI Installer</Button><br />
