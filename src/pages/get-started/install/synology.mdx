...
For a complete cleanup, you should also remove the Synology NAS as a peer from your openZro deployment. Log in to the openZro web UI. Navigate to the Peers section. Find the peer corresponding to your Synology NAS and delete it.

## Video Walkthrough

{/* TODO(docs): record openZro walkthrough — upstream had: <YouTube videoId="9VKOAe_T038" /> */}
