...
1. Navigate to [openzro.io](https://openzro.io/) and click Get Started in the top-right corner. Or simply click [here](https://app.openzro.io/).
...
2. An [installation modal](https://app.openzro.io/install) will appear. Select your operating system (e.g., macOS, Windows, Linux). For this example, we're installing it on a macOS machine.
