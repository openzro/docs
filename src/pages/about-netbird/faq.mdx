...
<Note>
    Download the full list of openZro Cloud STUN/TURN/Relay endpoints and port requirements in <a href="/docs-static/files/openzro-cloud-endpoints.json" download>JSON format.</a>
</Note>
