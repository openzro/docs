...
<p>
    <img src="/docs-static/img/about-openzro/high-level-dia.png" alt="high-level-dia" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/about-openzro/mesh.png" alt="high-level-dia" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/about-openzro/management.png" alt="management-dia" className="imagewrapper-big"/>
</p>
...
<Note>
The **private key**, generated by the openZro client, **never leaves the machine**, ensuring that only the machine that owns the key can decrypt traffic addressed to it.
</Note>
...
<p>
    <img src="/docs-static/img/about-openzro/signal.png" alt="signal-dia" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/about-openzro/relay.png" alt="relay-dia" className="imagewrapper-big"/>
</p>
