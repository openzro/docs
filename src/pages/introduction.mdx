...
<Note>
    ...
    See a comparison between the self-hosted and cloud-hosted versions [here](/about-openzro/self-hosted-vs-cloud).
</Note>
...
It literally takes less than 5 minutes to deploy a secure point-to-point VPN with openZro.

<div className="not-prose mb-16 mt-6 flex gap-3">
  <Button href="https://your-management.example.com/" arrow="right" children="Try openZro Cloud" />
  <Button href="/selfhosted/selfhosted-quickstart" variant="outline-arrow" arrow="right" children="Deploy openZro Self-Hosted" />
</div>
