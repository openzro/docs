...
<p>
    <img src="/docs-static/img/manage/network-routes/concepts/openzro-network-routes.png" alt="Network Routes diagram" className="imagewrapper-big"/>
</p>

<Note>
Network Routes require openZro [v0.9.0](https://github.com/openzro/openzro/releases) or later.
</Note>
...
<p>
    <img src="/docs-static/img/manage/network-routes/concepts/openzro-network-routes-dns-routes.png" alt="DNS Routes diagram" className="imagewrapper"/>
</p>
...
<Note>
DNS Routes require openZro [v0.28.0](https://github.com/openzro/openzro/releases) or later. Wildcard domains are not supported.
</Note>

<Note>
Starting with openZro v0.59.0, the local DNS forwarder port changed from `5353` to `22054` to avoid collisions. The Management Service applies the new port only when all peers in the account run v0.59.0 or newer.
</Note>
...
<p>
    <img src="/docs-static/img/manage/network-routes/concepts/openzro-network-routes-add-button.png" alt="Add route button" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/concepts/openzro-network-routes-create.png" alt="Create network route form" className="imagewrapper" width="70%"/>
</p>

Click **Add Route** to save.

<p>
    <img src="/docs-static/img/manage/network-routes/concepts/openzro-network-routes-saved-new.png" alt="Saved network route" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/concepts/openzro-network-routes-groups-create.png" alt="Create route with peer group" className="imagewrapper" width="70%"/>
</p>

Click **Add Route** to save.

<p>
    <img src="/docs-static/img/manage/network-routes/concepts/openzro-network-routes-groups-saved-new.png" alt="Saved route with peer group" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/concepts/openzro-network-routes-create-ha.png" alt="Add HA peer to route" className="imagewrapper" width="70%"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/concepts/openzro-network-routes-saved-new-ha.png" alt="Saved HA route" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/concepts/openzro-network-routes-groups-attribution.png" alt="Group attribution for routes" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/concepts/openzro-network-routes-masquerading.png" alt="Routes without masquerading" className="imagewrapper-big"/>
</p>
