...
<Warning>
Without masquerade, traffic from unknown source IPs is rejected by openZro's policy engine. You cannot use ACL Groups or Network Resources without masquerade enabled.
</Warning>
