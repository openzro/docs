...
<Note>
    This feature requires openZro version 0.27.0 or later.
</Note>
...
<Note>
    Auto Apply requires openZro client version 0.55.0 or later.
</Note>
...
<p>
    <img src="/docs-static/img/manage/network-routes/use-cases/by-scenario/exit-nodes/openzro-peers.png" alt="Dashboard peers view" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/use-cases/by-scenario/exit-nodes/openzro-peers-routing-peer.png" alt="Routing peer selection" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/use-cases/by-scenario/exit-nodes/openzro-peers-add-exit-node.png" alt="Add exit node dialog" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/network-routes/use-cases/by-scenario/exit-nodes/openzro-peers-routing-peer-exit-node.png" alt="Exit node confirmation" className="imagewrapper-big"/>
</p>
