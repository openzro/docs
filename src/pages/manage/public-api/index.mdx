...
Most network management operations administrators do in the [openZro Dashboard](https://app.openzro.io) can also be done via openZro API using service users' access tokens.
...
To create a service user, you'll need to log in to your organization's account at https://app.openzro.io and navigate to the "Team" -> "Service Users" section of your account.
<p>
