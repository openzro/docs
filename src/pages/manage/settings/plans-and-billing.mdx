...
openZro offers diverse plans to accommodate various networking needs, ensuring scalable and secure connectivity.
...
Details can be found on our [pricing page](https://openzro.io/pricing).

## Usage-based Billing

openZro uses a pay-as-you-go model, charging only for active users or machines.
...
* If you integrate openZro with your [Identity Provider (IdP)](/manage/team/idp-sync),
...
Refer to our pricing calculator on the [pricing page](https://openzro.io/pricing#calculator) to estimate your monthly costs based on your expected usage.
...
openZro offers scalable plans for networks with a machine-based usage model. This approach is relevant, among other scenarios,
