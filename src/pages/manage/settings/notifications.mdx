...
export const description =
    'Configure email, webhook, and Slack notifications for important events in your openZro deployment.'
...
<Note>
    This feature is currently only available in the cloud version of openZro.
</Note>

<p>
    <img src="/docs-static/img/manage/settings/notifications/openzro-settings-notifications-overview.png" alt="Notifications overview showing Email, Webhook, and Slack channels" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/settings/notifications/openzro-notifications-email-channel.png" alt="Email notification channel configuration with recipients and event toggles" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/settings/notifications/openzro-notifications-webhook-channel.png" alt="Webhook channel page with Connect button" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/settings/notifications/openzro-notifications-webhook-create-general-tab.png" alt="Connect Webhook modal showing the General tab with endpoint URL and authentication options" className="imagewrapper"/>
</p>

4. Click `Continue` to move to the `Headers` tab. Optionally add any custom HTTP headers your endpoint requires.

<p>
    <img src="/docs-static/img/manage/settings/notifications/openzro-notifications-webook-headers-tab.png" alt="Connect Webhook modal showing the Headers tab for adding custom HTTP headers" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/settings/notifications/openzro-notifications-webhook-edit-delete.png" alt="Webhook channel page showing Edit and Delete options for a connected webhook" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/settings/notifications/openzro-notifications-slack-channel.png" alt="Slack notification channel page with Connect button" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/settings/notifications/openzro-notifications-slack-create-app.png" alt="Connect openZro with Slack - Step 1: Create a Slack App" className="imagewrapper"/>
</p>

    - Set the app name to `openZro Notifications`, select your workspace, and click `Create App`.

<p>
    <img src="/docs-static/img/manage/settings/notifications/openzro-notifications-slack-name-workspace.png" alt="Slack app creation - naming and workspace selection" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/settings/notifications/openzro-notifications-slack-incoming-webhooks.png" alt="Slack Incoming Webhooks settings page" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/settings/notifications/openzro-notifications-slack-webhook-url-copy.png" alt="Copying the Slack webhook URL" className="imagewrapper"/>
</p>

    - Paste the Webhook URL into the input field in the openZro modal.

<p>
    <img src="/docs-static/img/manage/settings/notifications/openzro-notifications-slack-webhook-url.png" alt="Connect openZro with Slack - Step 2: Enter Webhook URL" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/settings/notifications/openzro-notifications-slack-disconnect.png" alt="Slack channel disconnect option in the dropdown menu" className="imagewrapper"/>
</p>
