...
export const description =
    'Control Center provides a topological view of your openZro network, visualizing access relationships between peers, groups, and networks through an interactive graph interface.'
...
<Note>
    **Availability**: openZro Cloud (all plans) and self-hosted.
</Note>
<Note>
