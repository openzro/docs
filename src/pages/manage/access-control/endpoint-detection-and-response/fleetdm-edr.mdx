...
<Note>
    openZro matches FleetDM hosts to peers using the **hardware serial number** of the device. You must ensure that each of your devices has a unique serial number.
</Note>
