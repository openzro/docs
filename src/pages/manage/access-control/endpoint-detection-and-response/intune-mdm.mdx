...
{/* TODO(docs): record openZro walkthrough — upstream had: <YouTube videoId="W4DaE4Dj04o" /> */}
...
<p>
    <img src="/docs-static/img/manage/access-control/endpoint-detection-and-response/intune-mdm/getting-started.png" alt="openZro Get Started Intune MDM" className="imagewrapper-big"/>
</p>
