...
<p>
    <img src="/docs-static/img/manage/access-control/posture-checks/connecting-from-the-office/openzro-routes-list-local.png" alt="high-level-dia" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/access-control/posture-checks/connecting-from-the-office/openzro-routes-list-external.png" alt="high-level-dia" className="imagewrapper"/>
</p>
