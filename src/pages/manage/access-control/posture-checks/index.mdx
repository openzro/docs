...
{/* TODO(docs): record openZro walkthrough — upstream had: <YouTube videoId="-KlJUBuZrpo" /> */}
...
<Note>
    The Operating System Check requires openZro version [0.26.0](https://github.com/openzro/openzro/releases) or newer.
</Note>
