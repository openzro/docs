...
- A [openZro cloud account](https://app.openzro.io/) or [self-hosted instance](/selfhosted/selfhosted-quickstart)
...
1. Download openZro from [app.openzro.io/install](https://app.openzro.io/install)
2. Run the application and click **Connect** in the system tray
3. Complete the sign-up process in your browser
4. Verify the device appears in the [openZro dashboard](https://app.openzro.io/) under **Peers**
...
Invoke-WebRequest -Uri "https://pkgs.openzro.io/install.ps1" -OutFile "install.ps1"; .\install.ps1
...
1. Have employees install openZro from [app.openzro.io/install](https://app.openzro.io/install)
