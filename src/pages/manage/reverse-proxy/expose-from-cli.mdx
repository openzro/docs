...
export const description =
    'Expose local HTTP and L4 services to the public internet directly from the command line using `openzro expose`, with optional authentication, custom domains, and automatic session management.'
