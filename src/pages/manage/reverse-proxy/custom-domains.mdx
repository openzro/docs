...
export const description =
    'Configure free and custom domains for openZro Reverse Proxy services, including CNAME verification and DNS setup.'
...
<Note>
    DNS changes can take time to propagate. If openZro does not find the record immediately, please wait up to 24 hours and try again.
</Note>
