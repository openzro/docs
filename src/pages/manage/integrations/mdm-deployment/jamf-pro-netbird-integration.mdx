...
* A [openZro account](https://app.openzro.io/) with administrative privileges.
...
* Upload or drop the package file in the **Filename** field. This tutorial uses the Apple Silicon package you can download [here](https://pkgs.openzro.io/macos/arm64). 
