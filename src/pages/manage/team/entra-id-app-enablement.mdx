...
<p>
    <img src="/docs-static/img/manage/team/entra-id-app-enablement/enterprise-applications.png" alt="Find openZro in Enterprise Applications" className="imagewrapper-big"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/team/entra-id-app-enablement/grant-admin-consent.png" alt="Grant admin consent for openZro" className="imagewrapper-big"/>
</p>

<Note>
    Granting admin consent allows openZro to access the necessary directory data for your organization. This is a one-time setup step.
</Note>
