...
<Note>
    ...
    [Embedded IdP version](/manage/team/idp-sync/embedded/jumpcloud-sync) of this guide.
</Note>
...
<Note>
    SCIM provisioning will manage only resources that are created through Jumpcloud. Any resources created directly in openZro will not be managed by SCIM.
</Note>
