...
<Note>
    If you are running a self-hosted deployment with a [Commercial License](https://openzro.io/pricing#on-prem) and the embedded IdP, see the [Embedded IdP version](/manage/team/idp-sync/embedded/microsoft-entra-id-sync) of this guide instead.
</Note>

## Get Started with openZro-Entra ID Integration

To get started, navigate to [Integrations](https://app.openzro.io/integrations) in the left menu, which will take you to the
