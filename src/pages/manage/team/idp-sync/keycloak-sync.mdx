...
<Note>
    ...
    [Embedded IdP version](/manage/team/idp-sync/embedded/keycloak-sync) of this guide.
</Note>
...
<Note>
    Synced groups will only be available for membership and will not change the role of user in openZro
</Note>