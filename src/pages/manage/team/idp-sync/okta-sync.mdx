...
This completes the first stage, enabling Single Sign-On (SSO) from openZro's login page using Okta credentials. Now, you can navigate to [app.openzro.io](app.openzro.io) and log in using [Okta Verify](https://help.okta.com/eu/en-us/content/topics/end-user/ov-overview.htm).
