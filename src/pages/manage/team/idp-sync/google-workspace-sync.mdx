...
<Note>
    If your deployment uses the **embedded IdP** (Zitadel installed by the
    quickstart bundle, or any of the [self-hosted IdPs](/selfhosted/identity-providers/)
    that openZro can manage as the OIDC source-of-truth), see the
    [Embedded IdP version](/manage/team/idp-sync/embedded/google-workspace-sync) of this guide.
</Note>
