...
<Note>
    ...
    [Embedded IdP version](/manage/team/idp-sync/embedded/microsoft-entra-id-scim-sync) of this guide.
</Note>
...
<Note>
    SCIM provisioning will manage only resources that are created through Microsoft Entra ID. Any resources created directly in openZro will not be managed by SCIM.
</Note>
