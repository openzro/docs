...
<Note>
    This guide covers the setup for cloud-hosted openZro. If you are using the self-hosted version, please refer
...
setup—just click the appropriate button on the [login page](https://app.openzro.io/):

<p>
    <img src="/docs-static/img/manage/team/single-sign-on/openzro-login.png" alt="openzro-login" className="imagewrapper"/>
</p>
