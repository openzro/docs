...
<Note>
    This feature is only available in the [openZro cloud](https://app.openzro.io/) version.
</Note>
...
To enable peer approval, navigate to [Settings &raquo; Authentication](https://app.openzro.io/settings) and enable 'Peer approval'.
...
## Approve peer
To approve a peer, navigate to the [peers tab](https://app.openzro.io/peers) and click the `Approve` button on the right side of the peers table.
