...
Setup keys are available in the openZro Management Dashboard under the `Setup Keys` tab [https://app.openzro.io/setup-keys](https://app.openzro.io/setup-keys).
...
<p>
    <img src="/docs-static/img/manage/peers/register-machines-using-setup-keys/openzro-peer-auto-tagging-newkey.png" alt="high-level-dia" className="imagewrapper"/>
</p>
