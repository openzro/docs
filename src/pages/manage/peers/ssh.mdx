...
<Note>
    Management distributes openZro access-policy objects (FirewallRule) - it does
...
<p>
    <img src="/docs-static/img/manage/peers/ssh/ssh-client.png" alt="openzro ssh client"
...
<p>
    <img src="/docs-static/img/manage/peers/ssh/ssh-access-policy.png" alt="openzro ssh access policy" className="imagewrapper"/>
</p>
...
<p>
    <img src="/docs-static/img/manage/peers/ssh/ssh-fine-grained-access-policy.png" alt="openzro ssh fine grained access policy" className="imagewrapper"/>
</p>
...
<Note type="warning">
    **Breaking change**: Management server v0.61.0 will break openZro SSH for all peers running versions older than v0.61.0. You must update all peers that use SSH to v0.61.0 or later before upgrading the management server/dashboard.
</Note>
...
<p float="center">
    <Button name="button" className="button-5"
            onClick={() => window.open("https://openzro.io/pricing")}>Use
        openZro</Button>
</p>
