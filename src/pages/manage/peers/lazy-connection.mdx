...
<Note>
    This feature also requires an upgraded openZro Management and Signal server.
    If you're self-hosting openZro, ensure your server is updated to version <strong>v0.50.1</strong>, which adds support for lazy connections.
</Note>
