export const description = 'Configure openZro to work with internal DNS servers like Active Directory, BIND, and Unbound. Includes troubleshooting WireGuard port conflicts on Domain Controllers.'
...
<img src="/docs-static/img/manage/dns/openzro-nameserver-add-button.png" alt="Add nameserver" className="imagewrapper"/>
...
<img src="/docs-static/img/manage/dns/openzro-nameserver-custom.png" alt="Custom DNS provider" className="imagewrapper"/>

5. Under **Domains**, add a **Match Domain** and enter your internal domains (e.g., `corp.local`, `company.internal`)

<img src="/docs-static/img/manage/dns/openzro-nameserver-add-domain.png" alt="Add match domain" className="imagewrapper"/>
...
<Note>
This port exclusion persists across reboots. If you later change the WireGuard listen port in your openZro configuration, update the exclusion range accordingly.
</Note>
