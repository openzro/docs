...
<Note>
Wildcard matching follows standard DNS rules ([RFC 4592](https://www.rfc-editor.org/rfc/rfc4592)): only a single subdomain level is matched. `deep.sub.myserver.openzro.cloud` would **not** match `*.myserver.openzro.cloud`.
</Note>
