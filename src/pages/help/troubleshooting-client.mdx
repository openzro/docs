...
<Note>
  The flag `--anonymize (-A)` can be used to anonymize IP addresses and non-openzro.io domains in logs and status output when needed.
</Note>
...
<Note>
  The flag `--anonymize` can be used to anonymize IP addresses and non-openzro.io domains in logs and status output when needed.
</Note>
...
<Note>
  If needed, you can update the upload URL and select to anonymize sensitive information like IP addresses and non-openzro.io domains in logs and status output.
</Note>
<p>
