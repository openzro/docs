...
<Note>
For a full list of available configuration options, see the [config.yaml.example](https://github.com/openzro/openzro/blob/main/combined/config.yaml.example) reference file.
</Note>
...
<Note>
Since version [0.28.0](https://github.com/openzro/openzro/releases/tag/v0.28.0), support for JSON file storage has been removed. All installations should be on SQLite or PostgreSQL.
</Note>
