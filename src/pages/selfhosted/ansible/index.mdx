...
- **`openzro_routing_peer` not yet shipped.** Routing peers
  (gateways, exit nodes) are tracked on the
  [roadmap](https://github.com/openzro/openzro/blob/main/docs/ROADMAP.md);
  for K8s, the [operator's](/selfhosted/operator/crds) `OZRoutingPeer`
  CRD covers this case today.
