...
<p>
    <img src="/docs-static/img/selfhosted/identity-providers/managed/google-workspace/5_openzro-complete-google.png" alt="openZro complete configuration" className="imagewrapper-big"/>
</p>
...
<Note>
Domain restrictions are configured in Google Cloud Console, not in openZro.
</Note>
