...
<Note>
Beginning with openZro version v0.23.6 and onwards, the Google Workspace IdP manager no longer requires the custom admin role called `User and Schema Management`. We now use a read-only role for user information.
</Note>
...
OPENZRO_AUTH_OIDC_CONFIGURATION_ENDPOINT="https://accounts.google.com/.well-known/openid-configuration"
OPENZRO_USE_AUTH0=false
OPENZRO_AUTH_AUDIENCE="<OAUTH_CLIENT_ID>"
OPENZRO_AUTH_CLIENT_ID="<OAUTH_CLIENT_ID>"
OPENZRO_AUTH_CLIENT_SECRET="<OAUTH_CLIENT_SECRET>"
OPENZRO_AUTH_SUPPORTED_SCOPES="openid profile email"
...
OPENZRO_MGMT_IDP="google"
OPENZRO_MGMT_IDP_SIGNKEY_REFRESH=true
OPENZRO_IDP_MGMT_EXTRA_SERVICE_ACCOUNT_KEY="<BASE64_SERVICE_ACCOUNT_KEY>"
OPENZRO_IDP_MGMT_EXTRA_CUSTOMER_ID="<GOOGLE_WORKSPACE_CUSTOMER_ID>"
```
