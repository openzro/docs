...
<p>
    <img src="/docs-static/img/selfhosted/identity-providers/managed/microsoft-entra-id/azure/azure-openzro-api-permisssions.png" alt="openZro API permissions" className="imagewrapper-big"/>
</p>
...
```shell
OPENZRO_DOMAIN="<YOUR_DOMAIN>"
OPENZRO_AUTH_OIDC_CONFIGURATION_ENDPOINT="https://login.microsoftonline.com/<Directory (tenant) ID>/v2.0/.well-known/openid-configuration"
OPENZRO_USE_AUTH0=false
OPENZRO_AUTH_CLIENT_ID="<Application (client) ID>"
OPENZRO_AUTH_SUPPORTED_SCOPES="openid profile email offline_access User.Read api://<Application (client) ID>/api"
OPENZRO_AUTH_AUDIENCE="<Application (client) ID>"
OPENZRO_AUTH_REDIRECT_URI="/auth"
OPENZRO_AUTH_SILENT_REDIRECT_URI="/silent-auth"
OPENZRO_AUTH_USER_ID_CLAIM="oid"
OPENZRO_TOKEN_SOURCE="idToken"

OPENZRO_AUTH_DEVICE_AUTH_PROVIDER="none"

OPENZRO_MGMT_IDP="azure"
OPENZRO_IDP_MGMT_CLIENT_ID="<Application (client) ID>"
OPENZRO_IDP_MGMT_CLIENT_SECRET="<CLIENT_SECRET>"
OPENZRO_IDP_MGMT_EXTRA_OBJECT_ID="<Object ID>"
OPENZRO_IDP_MGMT_EXTRA_GRAPH_API_ENDPOINT="https://graph.microsoft.com/v1.0"
```
