...
OPENZRO_AUTH_OIDC_CONFIGURATION_ENDPOINT="https://<YOUR_OKTA_ORGANIZATION_URL>/.well-known/openid-configuration"
OPENZRO_USE_AUTH0=false
OPENZRO_AUTH_AUDIENCE="<OPENZRO_CLIENT_ID>"
OPENZRO_AUTH_CLIENT_ID="<OPENZRO_CLIENT_ID>"
...
OPENZRO_AUTH_DEVICE_AUTH_CLIENT_ID="<OPENZRO_NATIVE_CLIENT_ID>"
OPENZRO_AUTH_DEVICE_AUTH_AUDIENCE="<OPENZRO_NATIVE_CLIENT_ID>"
OPENZRO_AUTH_DEVICE_AUTH_SCOPE="openid email"
OPENZRO_AUTH_DEVICE_AUTH_USE_ID_TOKEN=true

OPENZRO_MGMT_IDP="okta"
