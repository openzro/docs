...
export const description = 'Enable CrowdSec IP reputation blocking for self-hosted openZro Proxy deployments.'
...
<Note>
CrowdSec IP reputation is currently available for self-hosted deployments. Support for openZro Cloud is coming soon.
</Note>
