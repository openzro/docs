# Why Wireguard with openZro?

Source: https://docs.netbird.io/about-openzro/why-wireguard-with-openzro
...
and openZro uses Wireguard to establish a secure tunnel between machines.
...
openZro simplifies the setup by automatically generating private and public keys, assigning unique private IP addresses, and takes care of sharing public keys between the machines.
...
Furthermore, openZro ensures connectivity by leveraging advanced [NAT traversal techniques](https://en.wikipedia.org/wiki/NAT_traversal)
...
openZro also monitors the connection health and restarts broken connections.
...
Check out the WireGuard [Quick Start](https://www.wireguard.com/quickstart/) guide to learn more about configuring "plain" WireGuard without openZro.