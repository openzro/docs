# openZro vs. Traditional VPN

Source: https://docs.netbird.io/about-openzro/openzro-vs-traditional-vpn
...
openZro decentralizes networks using direct point-to-point connections, as opposed to traditional models.
...
To achieve this, openZro client applications employ signalling servers to find other machines and negotiate connections.
...
outlined in the [Why Wireguard with openZro](/about-openzro/why-wireguard-with-openzro) section,
openZro installation doesn't require complex network and firewall configuration.
It just works, minimising the maintenance effort.

Finally, each machine or device in the openZro network verifies incoming connections accepting only the trusted ones.
