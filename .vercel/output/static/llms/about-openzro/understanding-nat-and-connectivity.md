...
Source: https://docs.netbird.io/about-openzro/understanding-nat-and-connectivity
...
> **Note:** The `100.64.0.0/10` range you see in mobile networks is reserved for Carrier-Grade NAT. openZro also uses this range for its internal addressing, which is intentional to avoid conflicts with typical private network ranges.
...
> **Note:** Self-hosted deployments can run their own relay servers. For best performance, deploy relay servers geographically close to your users.
...
> **Note:** Even when traffic is relayed, it remains end-to-end encrypted with WireGuard. The relay server cannot decrypt or inspect your traffic - it only forwards encrypted packets between peers.
