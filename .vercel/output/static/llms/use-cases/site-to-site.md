...
Source: https://docs.netbird.io/use-cases/site-to-site
...
```
Your Laptop ──────► openZro Tunnel ──────► Routing Peer ──────► Office Printer
...
```
Your Laptop ──────► openZro Tunnel ──────► Exit Node ──────► Internet
  (peer)                                     (peer)
```
