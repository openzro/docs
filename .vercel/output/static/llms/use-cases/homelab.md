...
Source: https://docs.netbird.io/use-cases/homelab

---

# Homelab Use Cases

openZro helps homelabbers securely access their home infrastructure from anywhere and connect multiple home networks together.
...
For connecting entire home networks (accessing devices that don't have openZro installed), see the [Site-to-Site Connectivity Guide](/use-cases/site-to-site).

## Recommended Setup

For most homelabbers, we recommend:

1. **Install openZro on your devices** - Laptop, phone, and any servers you access directly
...
| Run openZro on router | [MikroTik Guide](/use-cases/homelab/client-on-mikrotik-router) |