...
Source: https://docs.netbird.io/manage/team/idp-sync/microsoft-entra-id-scim-sync
...
> **Note:** If you are running a self-hosted deployment with a [Commercial License](https://openzro.io/pricing#on-prem) and the embedded IdP, see the [Embedded IdP version](/manage/team/idp-sync/embedded/microsoft-entra-id-scim-sync) of this guide instead.
...
> **Note:** Before starting the Entra ID SCIM integration you will need to be logged in via Microsoft Login. 
...
This action will trigger a pop-up window that will present you with a user-friendly wizard, guiding you through the synchronization process between openZro and Entra ID.
