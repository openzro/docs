...
Source: https://docs.netbird.io/manage/team/idp-sync/embedded/keycloak-sync
...
> **Note:** Before creating this integration, ensure you have a Keycloak connector configured in your embedded IdP.
...
To enable SCIM synchronization in openZro, navigate to `Integrations > Identity Provider Sync` in your openZro dashboard. Click the `Connect Generic SCIM` button.
