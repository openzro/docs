...
Source: https://docs.netbird.io/manage/team/idp-sync/embedded/google-workspace-sync
...
> **Note:** Before creating this integration, ensure you have a Google Workspace connector configured in your embedded IdP.
...
This will open a pop-up window featuring an intuitive wizard to guide you through the synchronization process between openZro and Google Workspace.
...
* `openZro` for the service account name
