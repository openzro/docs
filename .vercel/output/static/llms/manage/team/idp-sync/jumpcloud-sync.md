...
Source: https://docs.netbird.io/manage/team/idp-sync/jumpcloud-sync
...
> **Note:** If you are running a self-hosted deployment with a [Commercial License](https://openzro.io/pricing#on-prem) and the embedded IdP, see the [Embedded IdP version](/manage/team/idp-sync/embedded/jumpcloud-sync) of this guide instead.
...
Once SSO is configured, and you can successfully log in to openZro using your JumpCloud credentials, you can proceed with the SCIM setup below.
...
![openZro Jumpcloud Integration](/docs-static/img/manage/team/idp-sync/jumpcloud-sync/jumpcloud-connect.png)
