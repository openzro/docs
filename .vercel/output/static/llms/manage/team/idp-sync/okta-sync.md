...
Source: https://docs.netbird.io/manage/team/idp-sync/okta-sync
...
openZro's Okta integration enhances user management by allowing you to utilize Okta as your identity provider.
...
from openZro's login page using Okta credentials. Next, you’ll configure SCIM (System for Cross-domain Identity Management)
...
![openZro Okta Integration](/docs-static/img/manage/team/idp-sync/okta-sync/nwutb3Z.png)
...
![openZro Connect openZro with Okta](/docs-static/img/manage/team/idp-sync/okta-sync/dlgCUXo.png)
...
![Okta openZro App](/docs-static/img/manage/team/idp-sync/okta-sync/dgxJ916.png)
...
![Okta Assign People To openZro App](/docs-static/img/manage/team/idp-sync/okta-sync/WQ8O1l7.png)
...
![Okta Verify User Added To openZro](/docs-static/img/manage/team/idp-sync/okta-sync/bteoM6j.png)

After that, you will see your user listed in the openZro application.

![Okta User Added To openZro App](/docs-static/img/manage/team/idp-sync/okta-sync/IwaqFvj.png)
...
![openZro Connect openZro with Okta Sharing Credentials](/docs-static/img/manage/team/idp-sync/okta-sync/AYVAbEy.png)
...
The final step is to [send an email to the openZro team](support@openzro.io) with the authentication information you just retrieved:
...
This completes the first stage, enabling Single Sign-On (SSO) from openZro's login page using Okta credentials. Now, you can navigate to [your-management.example.com](your-management.example.com) and log in using [Okta Verify](https://help.okta.com/eu/en-us/content/topics/end-user/ov-overview.htm).

## Enabling Okta SCIM in openZro

In openZro, go to `Integrations > Identity Provider` and click on the `Connect to Okta` button.

![openZro Connect to Okta](/docs-static/img/manage/team/idp-sync/okta-sync/QbzudIU.png)

You will see a reminder of the permissions your user will require in Okta. Click the `Get Started →` button to continue.

![openZro User Permissions](/docs-static/img/manage/team/idp-sync/okta-sync/RBsJlzu.png)
...
![openZro SSO in Okta](/docs-static/img/manage/team/idp-sync/okta-sync/XYpJYW3.png)
...
![openZro Enable Okta SCIM](/docs-static/img/manage/team/idp-sync/okta-sync/aoPqKJR.png)
...
![Okta Entering openZro Bearer Token](/docs-static/img/manage/team/idp-sync/okta-sync/Wn6f9Pj.png)
...
![openZro Configure SCIM provisioning to openZro](/docs-static/img/manage/team/idp-sync/okta-scim-provisioning.png)

Back to Okta, click `Edit` as shown below.

![Okta Edit openZro App](/docs-static/img/manage/team/idp-sync/okta-sync/AcuWP2G.png)
...
![openZro Sync Groups to openZro](/docs-static/img/manage/team/idp-sync/okta-sync/fLHSNsd.png)
...
![Okta Assign openZro to Groups](/docs-static/img/manage/team/idp-sync/okta-sync/yGV0u5Y.png)

Once you assign the desired groups, click `Done`. You'll see the selected groups listed in Okta.

![Okta openZro Groups](/docs-static/img/manage/team/idp-sync/okta-sync/mxkdWc0.png)
...
![openZro Sync Groups to openZro](/docs-static/img/manage/team/idp-sync/okta-sync/8TAvguS.png)
...
> **Note:** SCIM provisioning will manage only resources that are created through Okta. Any resources created directly in openZro will not be managed by SCIM.
