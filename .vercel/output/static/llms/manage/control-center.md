...
Source: https://docs.netbird.io/manage/control-center

---

# Visualize Remote Access with Control Center

Control Center is a topological view in the openZro dashboard that visualizes who can access what across your environment. It maps **Peers**, **Groups**, and **Networks** to the resources they can reach and shows the access control policies that permit those connections.

> **Note:** **Availability**: openZro Cloud (all plans) and self-hosted.

> **Note:** **Permissions:** The Admin and Network Admin user roles can edit policies from Control Center. Learn more about
...
- Click any policy chip to edit it in the standard editor. openZro Networks and routing peers enable access to private subnets and IP resources.
