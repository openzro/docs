...
Source: https://docs.netbird.io/manage/network-routes/use-cases/by-configuration/access-control

---

# Configuring Routes with Access Control

> **Note:** This feature requires openZro version 0.30.0 or later.
...
> **Note:** If you assign an access control group to a route but no route access policies exist or are enabled, all routed traffic will be dropped. This differs from routes without an access control group, which permit all traffic.
...
```mermaid
graph LR
    A[openZro Peer A<br>Routing Client] --- B[openZro Peer B<br>Routing Peer]
    B --- C[Routed Network]
```
