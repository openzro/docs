...
Source: https://docs.netbird.io/selfhosted/identity-providers/advanced/keycloak
...
> **Note:** **Optional**: To enable automatic user deletion from Keycloak when deleted from openZro, add the `--user-delete-from-idp` flag to the management startup command and assign the `manage-users` role instead.
...
```shell
NETBIRD_AUTH_OIDC_CONFIGURATION_ENDPOINT="https://<YOUR_KEYCLOAK_HOST_AND_PORT>/realms/openzro/.well-known/openid-configuration"
NETBIRD_USE_AUTH0=false
NETBIRD_AUTH_CLIENT_ID="openzro-client"
NETBIRD_AUTH_SUPPORTED_SCOPES="openid profile email offline_access api"
NETBIRD_AUTH_AUDIENCE="openzro-client"

NETBIRD_AUTH_DEVICE_AUTH_CLIENT_ID="openzro-client"
NETBIRD_AUTH_DEVICE_AUTH_AUDIENCE="openzro-client"

NETBIRD_MGMT_IDP="keycloak"
NETBIRD_IDP_MGMT_CLIENT_ID="openzro-backend"
NETBIRD_IDP_MGMT_CLIENT_SECRET="<NETBIRD_BACKEND_CLIENT_SECRET>"
NETBIRD_IDP_MGMT_EXTRA_ADMIN_ENDPOINT="https://<YOUR_KEYCLOAK_HOST_AND_PORT>/admin/realms/openzro"
```

> **Note:** Make sure your Keycloak instance uses HTTPS. Otherwise, the setup won't work.
