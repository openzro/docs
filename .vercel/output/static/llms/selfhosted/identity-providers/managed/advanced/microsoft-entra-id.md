# Microsoft and Entra ID SSO with openZro Self-Hosted (Legacy)

Source: https://docs.netbird.io/selfhosted/identity-providers/managed/advanced/microsoft-entra-id
...
3. Fill in:
   ...
   - **Redirect URI**: Select `Single-page application (SPA)` and enter `https://<youropenzrodomain.com>/silent-auth`
4. Click **Register**
...
2. Under **Single-page application**, add another URI: `https://<youropenzrodomain.com>/auth`
...
3. Select **My APIs** tab → **openZro** → check `api` permission → **Add permissions**
...
You've configured all required resources in Azure AD. Continue with the [openZro Self-hosting Guide](/selfhosted/selfhosted-guide#step-4-disable-single-account-mode-optional).
