...
Source: https://docs.netbird.io/selfhosted/identity-providers/managed/okta
...
2. In the **Sign-in redirect URIs** field, paste the redirect URL you copied from openZro
...
> **Note:** The groups claim has a limit of 100 groups. If a user belongs to more than 100 groups that match the filter, the request will fail. Use a more specific filter (e.g., `^openZro-.*`) to limit the groups included.
...
For detailed instructions on the standalone setup, see the [Okta SSO with openZro Self-Hosted (Legacy)](/selfhosted/identity-providers/managed/advanced/okta) documentation.
