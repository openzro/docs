...
Source: https://docs.netbird.io/ipa/guides/authentication

---

# Authentication

You'll need to authenticate your requests to access any of the endpoints in the openZro API. In this guide, we'll look at how authentication works. openZro offers two ways to authenticate your API requests: OAuth2 and personal access tokens (PAT). {{ className: 'lead' }}
