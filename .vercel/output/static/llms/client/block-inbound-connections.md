...
Source: https://docs.netbird.io/client/block-inbound-connections
...
> **Note:** Available since openZro v0.46.0.
...
> **Note:** This setting overrides all policies from the management service. Even if an access control policy explicitly allows traffic to this peer, inbound connections will still be blocked.
