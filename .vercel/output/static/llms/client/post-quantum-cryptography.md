...
Source: https://docs.netbird.io/client/post-quantum-cryptography
...
> **Note:** openZro uses a [Golang implementation](https://github.com/cunicu/go-rosenpass) of the Rosenpass protocol by the [cunīcu](https://cunicu.li) project.

## Enable Rosenpass in openZro
> **Note:** This is still an experimental feature, may contain bugs, and is not supported on mobile devices.
...
> **Note:** If the Rosenpass feature is enabled on a peer it will only be able to communicate with other peers that have Rosenpass enabled.
